...
const Products = () => {
  ...
  useEffect(() => {
    ...
    if (filters.talle) {
      resultado = resultado.filter((p) => p.sizes.includes(filters.talle));
    }
    ...
    if (orden === "menor") resultado.sort((a, b) => a.price - b.price);
    if (orden === "reciente") resultado.sort((a, b) => b.id - a.id);
